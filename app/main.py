...
async def correct_grammar(text: str) -> str:
    system_prompt = (
        ...
        "Your responsibility is to correct grammar, spelling, punctuation, and sentence boundaries "
        "while preserving the user’s original wording, tone, and intent.\n\n"
        "Guidelines:\n"
        "- Fix typos, misspellings, and spacing errors.\n"
        "- Correct verb tense, subject–verb agreement, and articles.\n"
        "- Add or adjust punctuation only when it improves grammatical correctness.\n"
        "- Capitalize appropriately.\n"
        "- Merge or split sentences only if required for grammatical correctness.\n\n"
        "Intent handling:\n"
        "- Understand the user’s intent only to preserve meaning.\n"
